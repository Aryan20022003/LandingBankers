...
//cookie bar creating and adding the to document;
...
message.innerHTML =
  'hay there we will collect some information for researce <button class="btn btn--close-cookie">got it</button> !';
...
//smooth scrolling from know more to section 1
...
//reason no matter wheather we are listing the event or not it will happen at that any point so if event happen at any point it will bubble up and bring the formtion or epicenter
